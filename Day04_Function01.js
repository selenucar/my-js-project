...
//
console.log(square(3,4,true,'javascript')); // s=3, Reult = 9
//
...
console.log(addNumbers(1, 2, 3)); // --> overwriting : 1+2+3=6
console.log(addNumbers(5, 6)); // --> 5+6+4(comes from default value= 15
